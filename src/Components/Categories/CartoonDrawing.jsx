...
const CartoonDrawing = () => {
  ...
  const cartoonDrawing = crafts.filter(
    (craft) => craft.subCategoryName.toLowerCase() === "cartoon drawing"
  );

  return (
    <div>
      <h2 className="text-3xl font-bold text-center">All Cartoon Drawing{`'`}s</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {cartoonDrawing.map((craft) => (
